...
$.extend(true, $.fn.dataTableExt.oStdClasses, {
	"sFilterInput": "form-control border-top-left-radius-0 border-bottom-left-radius-0 ml-0 width-xl shadow-inset-1",
...
$.extend(true, $.fn.dataTable.defaults, {
	...
	*/
	...
	language: {
		...
		processing: '<div class="d-flex align-items-center justify-content-center fs-lg"><div class="spinner-border spinner-border-sm text-primary mr-2" role="status"><span class="sr-only"> Yükleniyor...</span></div></div>',
		...
		zeroRecords: "Gösterilcek kayıt bulunamadı."
	},
	initComplete: function (settings, json) {
